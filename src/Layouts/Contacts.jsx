    ...
    return (
        <div>
            <section data-aos="fade-up-right"
                ...
                className="py-6 mt-12 rounded-lg dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
                    ...
                    <div className="flex flex-row flex-wrap-reverse justify-center">
                        ...
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
                            <p className="dark:text-gray-600">Industrial Manager</p>
                        </div>
                        <div className="flex flex-col justify-center m-8 text-center">
                        ...
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
                            <p className="dark:text-gray-600">Cold Stored Specialest</p>
                        </div>
                        <div className="flex flex-col justify-center m-8 text-center">
                            ...
                            <p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
                            <p className="dark:text-gray-600"> Design Engineer</p>
                        </div>
                    </div>
                </div>
            </section>
