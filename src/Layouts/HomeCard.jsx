    ...
    return (
        < div data-aos="fade-up"
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                ...
                <Link to={`home/${id}`} type="button" className="flex  items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-violet-600 text-gray-50">View Property</Link>
            </div>
        </div>
    );
};
